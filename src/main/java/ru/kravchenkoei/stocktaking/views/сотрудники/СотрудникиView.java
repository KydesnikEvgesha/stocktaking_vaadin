package ru.kravchenkoei.stocktaking.views.сотрудники;
...
import ru.kravchenkoei.stocktaking.data.service.SamplePersonService;
import ru.kravchenkoei.stocktaking.views.MainLayout;

@PageTitle("Сотрудники")
@Route(value = "employee/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Tag("сотрудники-view")
@JsModule("./views/сотрудники/сотрудники-view.ts")
@Uses(Icon.class)
public class СотрудникиView extends LitTemplate implements HasStyle, BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "employee/%d/edit";
    ...
    public СотрудникиView(@Autowired SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("сотрудники-view", "flex", "flex-col", "h-full");
